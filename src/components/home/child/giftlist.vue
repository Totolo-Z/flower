  ...
  <div>
       <subcomment :commentId='swiper'></subcomment>
         ...
         <div class="flowerCategory">
          <ul>
              <li v-for="(item,index) in form" :key="index" @click="goGoodslist(item.id)">
                  <img :src="item.src">
                  <p>{{item.name}}</p>
              </li>
          </ul>
...
export default {
   data() {
        return {
            ...
            form:[
                {
                src:'../../../../static/images/lihe-1.png',
                name:'爱心型',
                id:'001',
              },
               {
                src:'../../../../static/images/lihe-2.png',
                name:'抱抱桶',
                id:'002',
              },
               {
                src:'../../../../static/images/lihe-3.png',
                name:'手提式',
                id:'003',
              },
               {
                src:'../../../../static/images/lihe-4.png',
                name:'长方形',
                id:'004',
              }
            ]
